...
import waterly.drinkwater.reminder.features.progress.domain.usecase.AllTimeStats
...
class ProgressViewModel(
    ...
    private fun generateSmartTip(weeklyStats: waterly.drinkwater.reminder.core.domain.model.WeeklyStats, allTimeStats: AllTimeStats): String {
        val chartData = buildChartData(weeklyStats.dailySummaries, weeklyStats.weekStartDate)
